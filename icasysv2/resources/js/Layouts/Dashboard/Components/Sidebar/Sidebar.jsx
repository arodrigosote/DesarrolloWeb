                ...
                {auth.user.rol === 0 ? (
                    <>
                        ...
                        <MenuList>
                            ...
                            <MenuItem className=""><Link href={route('alumno.courses')} className=" text-white w-full pt-3 pb-3 pl-4 gap-2 rounded-xl transition-colors text-lg flex items-center justify-start xs:text-[10px] md:text-[12px] xl:text-[14px]"><RiBook2Fill  className='text-xl' />Mis cursos</Link></MenuItem>
                            <MenuItem className=""><Link href={route('alumno.grades')} className=" text-white w-full pt-3 pb-3 pl-4 gap-2 rounded-xl transition-colors text-lg flex items-center justify-start xs:text-[10px] md:text-[12px] xl:text-[14px]"><RiDraftFill  className='text-xl' />Calificaciones</Link></MenuItem>
                        </MenuList>
                        <MenuList>
                            <MenuItem className=""><Link href={route('profile.show')} className=" text-white w-full pt-3 pb-3 pl-4 gap-2 rounded-xl transition-colors text-lg flex items-center justify-start xs:text-[10px] md:text-[12px] xl:text-[14px]"><RiUserFill className="text-xl"></RiUserFill>Perfil</Link></MenuItem>
                        </MenuList>
