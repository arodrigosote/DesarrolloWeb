...
import 'boxicons';
import { RiWhatsappLine, RiInstagramFill, RiYoutubeFill   } from "react-icons/ri";
            ...
            <div className="flex justify-center boxs">
                ...
                <div className="text-center w-64 box">
                    <a href="https://www.instagram.com/_icasys_/">
                        <div className="cajaImagenChica">
                            ...
                            <RiInstagramFill className="text-[#bc2a8d] flex justify-center mx-auto" size='160px'></RiInstagramFill>
                        </div>
                ...
                <div className="text-center w-64 box">
                    <a href="https://www.youtube.com/c/ICASYS">
                        <div className="cajaImagenChica">
                            <RiYoutubeFill className="text-[#c4302b] flex justify-center mx-auto" size='160px'></RiYoutubeFill>
                        </div>
                ...
                <div className="text-center w-64 box">
                    <a href="https://bit.ly/WhatsIcasys">
                        <div className="cajaImagenChica">
                            ...
                            <RiWhatsappLine className="text-[#128c7e] flex justify-center mx-auto" size='160px'></RiWhatsappLine>
                        </div>
