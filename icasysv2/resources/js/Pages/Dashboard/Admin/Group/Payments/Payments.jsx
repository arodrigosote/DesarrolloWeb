...
const Payments = (props) => {
    ...
    const handlePayments = (id) => {
        get(route('grupos.make.payments', id))
    }
    return (
        <>
            <ToastContainer />
            <DashboardLayout title={'Realizar pago a grupo'} auth={props.auth}>
                <TableContainer>
                    <Table>
                        <TableHead>
                            <TableRow>
                                ...
                                <TableRow key={group.id}>
                                    ...
                                    <TableCell>
                                        ...
                                        {props.auth.user.rol === 2 ? (
                                            <>
                                                <ButtonShow onClick={(e) => { handlePayments(group.id) }}>Realizar pagos</ButtonShow>
                                            </>
                                        ) : (
                                            <></>
                                        )}
