...
const GroupReceipt = ({ matchingReceipts }) => {
    return (
        <Document>
            {matchingReceipts.map((items, index) => {
                ...
                return (
                    <Page key={index} size="LETTER" style={[styles.container, { marginTop: 10 }]}>
                        ...
                        <View style={styles.box}>
                            <View style={styles.box_left}>
                                ...
                                <Text style={[styles.mid_text]}>{`${student.group.schedule.day.name} ${student.group.schedule.hour.name}`}</Text>
                            </View>
                        ...
                        <View style={styles.box_two}>
                            <View style={styles.box_left}>
                                ...
                                <Text style={[styles.mid_text]}>{`Colegiatura correspondiente a semana(s):`} {receipt.studentpayments.map((payment, idx) => (
                            ...
                            <View style={styles.box_right}>
                                ...
                                <Text style={[styles.mid_text]}>{convertirNumeroALetra(receipt.amount)} 00/100</Text>
                            </View>
                        </View>
