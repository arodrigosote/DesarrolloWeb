...
const ShowStudent = () => {
    ...
    const nuevoDataset = [...dataset];

    payments.forEach((payment) => {
      const weekNumber = payment.week_topay_number;

      // Asegurarse de que el índice sea válido restando 1
      const indice = weekNumber - 1;

      // Verificar si el índice es válido antes de intentar eliminar
      if (indice >= 0 && indice < nuevoDataset.length) {
        nuevoDataset.splice(indice, 1);
      }
    });
    ...
    const resetForm = () => {
        ...
        setData({
            ...
            payment_date_104: formatterCurretDate,
            payment_check_104: false,
          // ...restablecer otros campos a sus valores iniciales
        });
    };
    ...
    const submit = (e) => {
        ...
        Swal.fire({
            title: '¿Está seguro que quiere registrar los pagos?',
            ...
            if (result.isConfirmed) {
                // La lógica a ejecutar si el usuario hace clic en "Sí"
                ...
                // La lógica a ejecutar si el usuario hace clic en "No" o cierra el cuadro de diálogo
