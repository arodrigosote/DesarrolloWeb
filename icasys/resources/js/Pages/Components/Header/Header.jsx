            ...
            <header className='header bg-primary'>
                ...
                <div className='right-section'>
                    {auth.auth.auth.user !== null ? (
                        ...
                        <>
                            <Link href={route('login')} className='bg-white p-3 mx-2 text-primary rounded-[15px] font-bold text-sm'>Iniciar sesión</Link>
                            <Link href={route('register')} className='bg-yellow p-3 text-primary rounded-[15px] font-bold text-sm'>Registrarse</Link>
                        </>
                    )}
